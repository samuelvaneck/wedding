...
/* WEBPACK VAR INJECTION */(function($) {window.handleKeyUpSearch = function (_this) {
  window.delaySearch(function () {
    window.searchItems(_this);
  }, 400);
};

window.searchItems = function (_this) {
  var url = $(_this).attr("data-search-path");
  var data = {};
  data.search = $(_this).val();
  data.target = $(_this).attr("data-table");
  console.log(_this); // $.get(url, data, "", "script");
};
...
/******/ });
//# sourceMappingURL=search-3e71a5523ac8b0eda70b.js.map