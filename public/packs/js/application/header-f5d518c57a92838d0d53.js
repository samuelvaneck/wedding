...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/application/header.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/application/header.js":
/*!****************************************************!*\
  !*** ./app/javascript/packs/application/header.js ***!
  \****************************************************/
...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('touchstart', '.header-img, .header-content', function () {
  var addingClass = $(this).hasClass('header-img') ? 'header-img-hover' : 'header-content-hover';
  $(this).addClass(addingClass);
});
$(document).on('touchend', '.header-img, .header-content', function () {
  var removingClass = $(this).hasClass('header-img') ? 'header-img-hover' : 'header-content-hover';
...
/******/ });
//# sourceMappingURL=header-f5d518c57a92838d0d53.js.map