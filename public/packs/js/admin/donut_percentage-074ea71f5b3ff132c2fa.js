...
var PercentageChart = function PercentageChart(id) {
  ...
  this.path = svg.selectAll("path").data(pie(dataset.lower)).enter().append("path").attr("fill", function (d, i) {
    return color(i);
  }).attr("d", arc).each(function (d) {
    _this._current = d;
  });
  this.text = svg.append("text").attr("text-anchor", "middle").attr("dy", ".3em");
  this.progress = 0;
};
...
/******/ });
//# sourceMappingURL=donut_percentage-074ea71f5b3ff132c2fa.js.map