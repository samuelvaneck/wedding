...
window.percentageChart = function (id) {
  ...
  setTimeout(function () {
    _this2.path = _this2.path.data(pie(dataset.upper));

    _this2.path.transition().duration(duration).attrTween("d", function (d) {
...
/******/ });
//# sourceMappingURL=donut_percentage-a86f1af4da6d3b8f25df.js.map