...
describe Admin::GuestsController do
  ...
  describe "#POST update" do
    context "with valid params" do
      before do
        post :update, params: { family_id: family.id, id: guest.id, guest: { name: "Test update", family_id: family.id } }
        guest.reload
      end
    ...
    context "with invalid params" do
      before do
        post :update, params: { family_id: family.id, id: guest.id, guest: { name: "", family_id: family.id } }
        guest.reload
      end
